...
public class TotalProductDescriptionQuery
    extends QueryCondition
{
    ...
    public TotalProductDescriptionQuery setIds(Long[] ids) {
        this.ids = ids;
        return this;
    }
    ...
    public TotalProductDescriptionQuery setMinTotalCountRows(Integer minTotalCountRows) {
    ...
    public TotalProductDescriptionQuery setMaxTotalCountRows(Integer maxTotalCountRows) {
    ...
    public TotalProductDescriptionQuery setTotalCountRows(Boolean totalCountRows) {
    ...
    public TotalProductDescriptionQuery setStartCreatedDate(Date startCreatedDate) {
    ...
    public TotalProductDescriptionQuery setEndCreatedDate(Date endCreatedDate) {
    ...
    public TotalProductDescriptionQuery setProductId(Long productId) {
        this.productId = productId;
        return this;
    }

    public TotalProductDescriptionQuery setGroupByCreatedDate(DateGroupBy dateGroupBy) {
    ...
    public TotalProductDescriptionQuery setJoinProduct(com.xmg.mall.base.query.JoinType joinProduct) {
    ...
    public TotalProductDescriptionQuery setProductQuery(ProductQuery productQuery) {
        this.productQuery = productQuery;
        return this;
    }

    public TotalProductDescriptionQuery setJoinProduct() {
