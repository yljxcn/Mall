...
public class TotalImpressionQuery
    extends QueryCondition
{
    ...
    public TotalImpressionQuery setIds(Long[] ids) {
        this.ids = ids;
        return this;
    }
    ...
    public TotalImpressionQuery setMinTotalCountRows(Integer minTotalCountRows) {
    ...
    public TotalImpressionQuery setMaxTotalCountRows(Integer maxTotalCountRows) {
    ...
    public TotalImpressionQuery setTotalCountRows(Boolean totalCountRows) {
    ...
    public TotalImpressionQuery setStartCreatedDate(Date startCreatedDate) {
    ...
    public TotalImpressionQuery setEndCreatedDate(Date endCreatedDate) {
    ...
    public TotalImpressionQuery setLikeName(String likeName) {
    ...
    public TotalImpressionQuery setName(String name) {
        this.name = name;
        return this;
    }

    public TotalImpressionQuery setGroupByCreatedDate(DateGroupBy dateGroupBy) {
