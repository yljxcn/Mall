...
<form action="/skuProperty/save" method="post">
    <div class="row">
        <div class="col-lg-6">
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                <label>默认可选值</label>
                <textarea class="form-control" name="skuPropertyDefaultValues" rows="3" placeholder="以逗号分隔"></textarea>
            </div>
        </div>
    </div>
...
<script>
    initRefresh({toSaveUrl: '/skuProperty/toSave'});
</script>
