...
<head>
    ...
    <script>
        $(function(){
            initMenu();
            initFormAndTable({url:'/product/list'});
        ...
        <div id="content_body" class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><i class="fa fa-fw fa-cube"></i> 商品</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row button-group">
                <div class="col-lg-9 text-left">
                    ...
                    <button id="addProduct" type="button" class="btn btn-primary"><i class="fa fa-fw fa-plus"></i> 增加</button>
                    <button id="updateProduct" type="button" class="btn btn-primary disabled"><i class="fa fa-fw fa-edit"></i> 修改</button>
                ...
                <form role="form" id="search-form" action="/catalog/list">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label>名称</label>
                            <input class="form-control" name="likeName">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
