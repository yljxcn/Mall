<div class="row">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><i class="fa fa-fw fa-plus"></i> 添加品牌</li>
...
<form action="/brand/save" method="post" enctype="multipart/form-data">
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="form-group">
                <label>英文名</label>
                <input class="form-control" name="englishName">
            </div>
        </div>
        <div class="col-lg-4">
            <div class="form-group">
                ...
                <div class="date form_datetime input-group">
                    <input size="16" name="foundDate" type="text" readonly class="form-control">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="form-group">
                <label>排序</label>
                <input class="form-control" name="sequence">
            </div>
        </div>
        <div class="col-lg-4">
            <div class="form-group">
                ...
                <div>
                    <label class="radio-inline">
                        <input type="radio" name="mods" value="1" checked>是
                    </label>
                    <label class="radio-inline">
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <img id="output" height="30%" width="30%">
            </div>
        </div>
    </div>
