...
<head>
    ...
    <script>
        $(function(){
            initMenu();
            initFormAndTable({url:'/catalog/list',toSaveUrl: '/catalog/toSave',toUpdateUrl: '/catalog/toUpdate'});
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><i class="fa fa-fw fa-navicon"></i> 分类</li>
                    </ol>
                </div>
            </div>
